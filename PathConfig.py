...
# Data filename
if SimulateData:
    tagD0 = '2-D_velocity_tokyobay.txt.mat'
    tagV0 = '2-D_velocity_tokyobay.txt.mat'
    tagD1 = '2-D_velocity_tokyobay.txt'
    tagV1 = '2-D_velocity_tokyobay.txt'
else:
    tagD0 = 'srec'
    tagV0 = 'svmodel'
    tagD1 = 'Rec'
...
main_dir   = '/home/pingchuan/FCN_tokyo/'     # Replace your main path here
